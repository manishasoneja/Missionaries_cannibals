...
void font_display(){
    ...
    glColor3f(1,0.0,0.0);
    drawString(350,650,0,"MISSIONARIES AND CANNIBALS");
    glColor3f(1,0,1);
    ...
    glColor3f(1,0.1,1);
    drawString(450,50,0,"PRESS 'I' FOR INSTRUCTIONS");
    //glutSwapBuffers();
}
void instructions(){
    ...
    glColor3f(1,0,0);
    setFont(GLUT_BITMAP_HELVETICA_18);
    drawString(400,950,0,"INSTRUCTIONS:");
    glColor3f(0,0,1);
    drawString(50,850,0,"The missionaries have red hair and the cannibals have black hair.");
    glColor3f(0,0,1);
    drawString(50,800,0,"Click to transfer the missionaries and the cannibals to the opposite bank.");
    glColor3f(0,0,1);
    drawString(50,750,0,"To move missionaries/cannibals to the right use RIGHT MOUSE BUTTON");
    glColor3f(0,0,1);
    drawString(50,700,0,"To move missionaries/cannibals  to the left use LEFT MOUSE BUTTON.");
     glColor3f(0,0,1);
    drawString(50,650,0,"To the move the boat from left bank to right bank use “-> KEY” and from right bank to left bank “<- KEY”.");
    glColor3f(0,0,1);
    drawString(50,600,0,"Be careful,when the number of missionaries is smaller than that of the cannibals on a side,the missionaries");
    glColor3f(0,0,1);
    drawString(50,550,0,"will be eaten!!");
    glColor3f(0,0,1);
    drawString(50,450,0,"PRESS R TO RESET");
    glColor3f(0,0,1);
    drawString(400,350,0,"PRESS ENTER TO START");
    glutSwapBuffers();
}
...
void mouse(int btn,int state,int x,int y){
    ...
    if(btn==GLUT_RIGHT_BUTTON && state==GLUT_DOWN){
            printf("x=%d y=%f vis=%d onboat=%d\n",x,scaled_y,left_cannibal_visibility[0],onboat);
            if(x>=13 && x<=32 && scaled_y>=283 && scaled_y<=348 && left_cannibal_visibility[0]==1 && onboat<2 && flag2==0){
                printf("ENTERS FUNC");
            ...
            else if(x>=63 && x<=81 && scaled_y>=283 && scaled_y<=348 && left_cannibal_visibility[1]==1 && onboat<2 && flag2==0){
                printf("ENTERS FUNC");
            ...
            else if(x>=112 && x<=131 && scaled_y>=283 && scaled_y<=348 && left_cannibal_visibility[2]==1 && onboat<2 && flag2==0){
                printf("ENTERS FUNC");
            ...
            else if(x>=162 && x<=182 && scaled_y>=283 && scaled_y<=348 && left_missionary_visibility[0]==1 && onboat<2 && flag2==0){
                printf("ENTERS FUNC");
            ...
            else if(x>=211 && x<=230 && scaled_y>=283 && scaled_y<=348 && left_missionary_visibility[1]==1 && onboat<2 && flag2==0){
                printf("ENTERS FUNC");
            ...
            else if(x>=263 && x<=283 && scaled_y>=283 && scaled_y<=348 && left_missionary_visibility[2]==1 && onboat<2 && flag2==0){
                printf("ENTERS FUNC");
    ...
    else if(btn==GLUT_LEFT_BUTTON && state==GLUT_DOWN && flag2==0){
...
void keyfunc(int keyfun,int x,int y){
    if(keyfun==GLUT_KEY_RIGHT && (boat_left_character==1 || boat_right_character==1) && flag2==0){
            BoatTranslate_right();
    }
    if(keyfun==GLUT_KEY_LEFT && (boat_left_character==1 || boat_right_character==1) && flag2==0){
        //game_over();
        BoatTranslate_left();
        }
}
